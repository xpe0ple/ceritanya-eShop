...
@section('content')
    <div class="row mt-4 align-items-center">
        <div class="col-md-6">
            <div class="content-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odio repellendus porro fugit aspernatur voluptate incidunt soluta delectus dolorum, quisquam quos?
            </div>
        </div>
        <div class="col-md-6">
            <img src="{{asset('assets/images/ayang.jpg')}}" style="width: 115%; border-radius: 10px;" alt="">
        </div>
    </div>
    ...
    <h4 class="text-center mt-md-5 mb-md-3">Contact Us</h4>
    <hr class="mb-4" style="border: 2px solid #257180">
    <div class="row mb-md-5">
        <div class="col-md-5">
            <div class="bg-secondary" style="width: 100%; height: 66vh; border-radius: 10px;"></div>
        </div>
        <div class="col-md-7">
            <div class="card">
