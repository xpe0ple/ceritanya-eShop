...
<div class="card ">
    <div x-data="{ qty: 1, harga: 200000, total() { return this.qty * this.harga } }" class="card-body d-flex gap-4">
        ...
        <div class="desc">
            ...
            <div class="row mt-3">
                ...
                <input type="text" class="col-sm-5 form-control w-50 border-0" readonly x-bind:value="total()">
            </div>
            <div class="row">
                <div class="col-sm-12 d-flex flex-column mt-3">
                    <a href="/checkOut" class="btn btn-success mb-2 w-50 d-flex align-items-center justify-content-center" style="border-radius: 15px;">
                        <i class="fa fa-shopping-cart me-2"></i> 
                        <span>Checkout</span>
                    </a>                
                    <a href="" class="btn btn-danger mb-2 w-50 d-flex align-items-center justify-content-center" style="border-radius: 15px;">
